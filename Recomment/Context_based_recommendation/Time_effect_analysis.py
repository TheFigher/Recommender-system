...
class Demo:
    ...
    def showItem(self):
        ...
        if os.path.exists("data/itemUserRate.json"):
            ...
            json.dump(itemUserRate, open("data/itemUserRate", "w"))
    ...
    def showPicture(self, _dict, label):
        ...
        new_dict = sorted(_dict.items(), key=lambda x:x[0], reverse=False) # false 升序
...
if __name__ == '__main__':
    filePath = r"C:\Users\administered\Desktop\推荐系统开发实战\数据\data\netflix\training_set"
    demo = Demo(filePath)
